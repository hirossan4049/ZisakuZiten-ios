...
class Playlist{
    let flashcard = PlayListItem(title: "FlashCard",subtitle:"単語と意味が交互に表示されます。", comment: "単語と意味が交互に表示されます。",
                                 groupMinCount: 1,image1: "flashcardImage1",image2: "flashcardImage2",image3: "",viewController: FlashCardViewController(nibName: "FlashCardViewController", bundle: nil))
